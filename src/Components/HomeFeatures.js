                ...
                <View style={styles.featureSubContainer}>
                    <TouchableOpacity onPress={props.onTransferPress} style={{ justifyContent: 'center', alignItems: 'center' }}>
                        <View style={styles.iconContainer}>
                            ...
                            <Image source={require('../images/send.png')} style={styles.featureImg} />
                        </View>
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                <View style={styles.featureSubContainer}>
                    <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Icon color='#333' name='qrcode' type='font-awesome' size={RFValue(35, 580)} color="#7ADAE0" style={styles.icon} />
                        </View>
